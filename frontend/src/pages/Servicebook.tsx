    ...
    return (
        <>
            ...
            <main className="booking-service-page">
                <section className="service-top-banner">
                    <div className="service-top-overlay"></div>

                    <div className="service-top-content">
                        <p className="service-top-small">Luxury Salon &amp; Spa Services</p>

                        <h1>
                            High-end services <em>for</em> <br />
                            clients <em>who</em> deserve <br />
                            to be <em>pampered.</em>
                        </h1>
                    </div>
                </section>
                ...
                <section className="service-booking-list-section animate-fade-up">
                    ...
                    selectedTime && (
                        <div className="datetime-popup-overlay">
                            <div className="datetime-popup-card animate-fade-up wide-confirmation-modal">
                                ...
                                <div className="popup-body">
                                    <div className="luxury-confirmation-card">
